...
| 02 | jt | 目标地址(u32) | 当栈顶一个u32不为0时跳转到目标地址 |
...
| 2A | ei32 | | 两个i32进行等于比较 |
| 2B | i32tof32 | | 栈顶从i32转换为f32 |
| 2C | i32tou32 | | 栈顶从i32转换为u32 |
| | | |
| 30 | addu32 | | 两个u32相加 |
| 31 | subu32 | | 两个u32相减 |
| 32 | mulu32 | | 两个iu2相乘 |
...
| 3A | eu32 | | 两个u32进行等于比较 |
| 3B | u32tof32 | | 栈顶u32转换为f32 |
| 3C | u32toi32 | | 栈顶从u32转换为i32 |
| | | |
| 40 | addf32 | | 两个u32相加 |
| 41 | subf32 | | 两个u32相减 |
| 42 | mulf32 | | 两个iu2相乘 |
...
| 4A | ef32 | | 两个u32进行等于比较 |
| 4B | f32tou32 | | 栈顶f32转换为u32 |
| 4C | f32toi32 | | 栈顶从u32转换为i32 |
